...
def main()->int:
    ...
    require(summary['verdict']=='PASS_V30_SOURCEBLIND_CANONICAL_SONOTACO_PRETRUTH_CATALOGUE_FREEZE','pretruth catalogue not frozen')
    ...
    require(catalogue['feature_dimension']==21 and catalogue['source_specific_features_used'] is False,'source-specific ranking information entered v30')
    ...
    result={
        'scientific_stage':'V30_SOURCEBLIND_CANONICAL_SONOTACO_EXPOSED_LITERATURE_DEVELOPMENT',
        'single_canonical_detector_catalogue':True,'panel_specific_candidate_generation':False,'panel_specific_ranking':False,
        'candidate_catalogue_sha256':sha(a.catalogue),'candidate_order_sha256':catalogue['v30_order_sha256'],
        'candidate_counts':catalogue['candidate_counts'],'membership_diagnostics':catalogue['membership_diagnostics'],
        'feature_dimension':21,'source_specific_features_used':False,
        'panels':panels,'panel_wins':wins,
        'verdict':'PASS_V30_SOURCEBLIND_CANONICAL_SONOTACO_ALL_PANEL_LITERATURE_SUPERIORITY_DEVELOPMENT' if passed else 'FAIL_V30_SOURCEBLIND_CANONICAL_SONOTACO_ALL_PANEL_LITERATURE_SUPERIORITY_DEVELOPMENT',
        ...
        'parameter_search':False,'post_result_second_search':False,'source_quota_selected':False,'partial_source_feature_restoration':False,
        'maarsy_scientific_access':False,'dms_scientific_access':False,'target_information_access':False,
    }
    (a.output/'V30_SOURCEBLIND_CANONICAL_SONOTACO_EXPOSED_RESULT.json').write_text(json.dumps(result,indent=2,sort_keys=True,allow_nan=False)+'\n')
