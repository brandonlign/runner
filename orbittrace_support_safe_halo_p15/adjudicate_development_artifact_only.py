...
P12_RESULT_SHA256='86ddb282141330896343fb2f63b46b0b8b0cf7d5d9b3a6167aa451f63a7ed03b'
...
def main()->int:
    ...
    require(p12['target_information_access'] is False,'canonical P12 target access changed')
    ...
    result={
        ...
        'scientific_interpretation':'P15 changes only the behavior of exact-P12 secondary characterization when a direction has <128 target-window negatives. On immutable canonical development every one of the 452 directions is eligible, so the P15 fallback is mathematically vacuous and canonical P12/P13 outputs remain the promoted development outputs without rerunning floating linear algebra.',
    }
