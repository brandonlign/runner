...
def from_maarsy_retained_geometry(
    *,
    ...
    require(isinstance(native_vels_km_s, Sequence) and len(native_vels_km_s) >= 2,
            "MAARSY vels must be a vector")
    components = [finite_float(x, "MAARSY velocity component") for x in native_vels_km_s]
