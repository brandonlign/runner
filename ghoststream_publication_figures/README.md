...
This directory renders the first checksum-backed figure set for the GhostStream paper, LISEF poster, and judge presentation.
...
All scientific panels read preserved tables or records from exact GitHub Actions artifacts. Figure 3A is explicitly schematic; it is the only panel that does not plot observed or benchmark records.
...
- SonotaCo 2023 replacement independent replication: artifact `8897103051`, ZIP SHA-256 `291a1e738b6e63cc36226b7bea1f69b253dcea18ebb97e620006f7ed2544fc3c`.

## Outputs

The workflow emits each figure as:
