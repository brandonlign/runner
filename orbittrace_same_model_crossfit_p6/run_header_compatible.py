...
EXPECTED_P6_SOURCE = Path('/tmp/run_p6.py')
...
def load_p6() -> Any:
    require(EXPECTED_P6_SOURCE.is_file(), f'P6 runtime missing: {EXPECTED_P6_SOURCE}')
    spec = importlib.util.spec_from_file_location('orbittrace_p6_runtime', EXPECTED_P6_SOURCE)
    require(spec is not None and spec.loader is not None, 'cannot load P6 runtime')
...
def self_test() -> None:
    ...
    print('PASS_P6_HEADER_WHITESPACE_COMPAT_SELF_TEST')
