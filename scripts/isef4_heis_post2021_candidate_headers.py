...
PAIR={"before":"M1474017887LE","after":"M1517286059LE"}
def fetch(url):
...
def main():
    ...
    try:
        ...
        result["scientific_status"]="both exact original NAC EDR and CDR headers verified, camera footprint and event pixels NOT yet verified"
        x.out.write_text(json.dumps(result,indent=2)+"\n")
        ...
        result["scientific_status"]="post2021 original pair source gate blocked"
