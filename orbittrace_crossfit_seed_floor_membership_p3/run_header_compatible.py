...
EXPECTED_P3_SOURCE = Path('/tmp/run_p3.py')
...
def load_p3() -> Any:
    ...
    spec = importlib.util.spec_from_file_location('orbittrace_p3_runtime', EXPECTED_P3_SOURCE)
    require(spec is not None and spec.loader is not None, 'cannot load P3 runtime')
