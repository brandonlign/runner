...
def main() -> None:
    ...
    source = replace_exact(source, 'CORPUS = "sonotaco-2023-fixed4-confirmation"', 'CORPUS = "sonotaco-2016-prospective"', "corpus")
    ...
    source = replace_exact(source, "EXPECTED_ROWS = 47_087", f"EXPECTED_ROWS = {EXPECTED_ROWS}", "row count")
