#!/usr/bin/env python3
"""Record immutable SonotaCo-2021 transport structure without reading labels or scores."""
...
YEAR = 2021
EXPECTED_MEMBER_SUFFIX = "/_U2_20210101_S.csv"
...
def main() -> None:
    ...
    result = {
        "verdict": "PASS_SONOTACO_2021_ARCHIVE_STRUCTURE_AUDIT",
        "classification": (
            "transport and schema audit; no shower-label values, coordinates, coefficients, "
            "component scores, augmented scores, or episode endpoints inspected"
        ),
        "year": YEAR,
        "archive": {
        ...
        "prohibited_access": {
            ...
            "sparse_tail_scores_computed": False,
            "positive_or_negative_episode_outcomes_computed": False,
        },
    }
    (args.output / "sonotaco_2021_archive_structure_audit.json").write_text(
