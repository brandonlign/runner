...
def main()->int:
    ...
    sm=station_struct['summary']; cs=pre['cross_scale']; req(abs(float(cs['successor_pooled_fine_to_coarse_mean_best_jaccard'])-float(sm['station_weighted_topomodal_pooled_fine_to_coarse_mean_best_jaccard']))<1e-12,'pooled structural mismatch'); req(int(cs['successor_strict_bucket_wins'])==4,'bucket wins mismatch')
