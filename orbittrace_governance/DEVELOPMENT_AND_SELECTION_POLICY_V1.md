...
- P19 is the current active successor and is already frozen; this policy does not modify its source, rule, gates, or current execution.
- If P19 fails, the next successor returns to the same GMN 2022/2023 corpus. It does not receive a new SonotaCo year.
