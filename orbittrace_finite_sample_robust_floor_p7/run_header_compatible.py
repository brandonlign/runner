...
EXPECTED_P7_SOURCE = Path('/tmp/run_p7.py')
...
def load_p7() -> Any:
    require(EXPECTED_P7_SOURCE.is_file(), f'P7 runtime missing: {EXPECTED_P7_SOURCE}')
    spec = importlib.util.spec_from_file_location('orbittrace_p7_runtime', EXPECTED_P7_SOURCE)
    require(spec is not None and spec.loader is not None, 'cannot load P7 runtime')
...
def self_test() -> None:
    ...
    print('PASS_P7_HEADER_WHITESPACE_COMPAT_SELF_TEST')
