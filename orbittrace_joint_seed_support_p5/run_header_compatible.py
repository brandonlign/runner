...
EXPECTED_P5_SOURCE = Path('/tmp/run_p5.py')
...
def load_p5() -> Any:
    require(EXPECTED_P5_SOURCE.is_file(), f'P5 runtime missing: {EXPECTED_P5_SOURCE}')
    spec = importlib.util.spec_from_file_location('orbittrace_p5_runtime', EXPECTED_P5_SOURCE)
    require(spec is not None and spec.loader is not None, 'cannot load P5 runtime')
...
def self_test() -> None:
    ...
    print('PASS_P5_HEADER_WHITESPACE_COMPAT_SELF_TEST')
