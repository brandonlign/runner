...
The active branch should contain a small, obvious execution surface. Historical failed experiments remain preserved in Git/PR history and are summarized in an archive index rather than left as runnable Actions workflows. Cleanup changes are made on a dedicated branch and reviewed by diff before merge.
