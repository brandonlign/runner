...
7. Current canonical GMN/SonotaCo/MAARSY event adapters, survey-independent v15 application, exact-equivalence tests, label-free v8+v15 qualification, and the gated SonotaCo applicability/literature path.
