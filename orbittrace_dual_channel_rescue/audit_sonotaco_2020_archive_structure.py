#!/usr/bin/env python3
"""Record immutable SonotaCo-2020 transport structure without reading labels or scores."""
...
YEAR = 2020
EXPECTED_MEMBER_SUFFIX = "/_U2_20200101_S.csv"
...
def main() -> None:
    ...
    result = {
        "verdict": "PASS_SONOTACO_2020_ARCHIVE_STRUCTURE_AUDIT",
        "classification": (
            "transport and schema audit; no shower-label values, coordinates, coefficients, "
            "component scores, dual-channel decisions, or episode endpoints inspected"
        ),
        "year": YEAR,
        "archive": {
        ...
        "prohibited_access": {
            ...
            "dual_channel_decisions_computed": False,
            "positive_or_negative_episode_outcomes_computed": False
        }
    }
    (args.output / "sonotaco_2020_archive_structure_audit.json").write_text(
