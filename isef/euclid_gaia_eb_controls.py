...
def tap(q):
 ...
 for u in TAPS:
  try:
   req=urllib.request.Request(u,data=body,headers={'User-Agent':'isef-euclid-eb-controls/1.2','Content-Type':'application/x-www-form-urlencoded'});raw=urllib.request.urlopen(req,timeout=30).read();return parse(raw),u
