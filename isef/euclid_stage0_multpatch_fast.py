...
def main():
    ...
    # deterministic geometry-only proposals distributed through the focal plane.
    ...
    for k in order:
        ...
        for dx,dy in offsets:
            ...
            for g in range(4):
                ...
                # 140 arcsec is proposal-only; exact WCS below is authoritative.
    ...
    rows=[]
    for p in selected:rows.append(m.run_patch(p))
